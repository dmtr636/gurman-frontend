        ...
        <div className={styles["modalContent"]}>
            {
                ...
                "\n" +
                "1.2.\tСайт Интернет-магазина «Гурман» (далее – Сайт) является собственностью ИП Мгерян Серёжа Меружанович\n" +
                "\n" +
